...
Unsere APs hatten die Nummbern 12 und 14, im weiteren als AP-12 und AP-14 bezeichnet.
...
Dazu haben wir bspw. die Ping- und Iperf-Messungen auf unseren Notebooks durchgeführt, die jeweils mit einem Access Point (APs) verbunden wurden.
...
\begin{itemize}
  ...
  \item[Multi-Hop] die kommunizierenden Endpunkte sind über ihre unterschiedlichen Access Points und weitere, zusätzliche Hops (Access Points) miteinander verbunden
\end{itemize}

Um die Szenarien deutlicher zu beschreiben lassen sich die Statistiken der Routing-Daemons abfragen.
...
Für B.A.T.M.A.N. sieht das 1-Hop-Szenario bspw. wie folgt aus (AP-12):
...
Der best next Hop um zu AP-14 zu gelangen ist AP-14 selbst, d.h. bei einer Kommunikation von AP-12 zu AP-14 liegt kein weitere HOP dazwischen.

Für B.A.T.M.A.N. sieht das Multi-Hop-Szenario bspw. wie folgt aus (AP-12):
...
Der best next Hop um zu AP-14 zu gelangen ist AP-53, d.h. bei einer Kommunikation von AP-12 zu AP-14 liegt mindstens 1 weiterer Hop dazwischen.

Um den OLSR-Routing-Daemon nach seinen Routing-Entscheidungen zu befragen wurde das OLSR-HttpInfo-Modul benutzt.

Figure \ref{1hop_olsr} zeigt die Routing-Informationen für OLSR bzgl. des 1-Hop-Szenarios (AP-12).
...
Die Route zu AP-14 weist die Metrik 1 auf und der Gateway zu AP-14 ist AP-14 selbst, d.h. bei einer Kommunikation von AP-12 zu AP-14 liegt kein weiterer Hop dazwischen.
...
Die Route zu AP-14 weist die Metrik 2 auf und der Gateway zu AP-14 ist AP-13, d.h. bei einer Kommunikation von AP-12 zu AP-14 liegt ein weiterer Hop dazwischen.
...
Um zunächst einen groben Eindruck vom vorhandenen Jitter zu erhalten kann die Latenz der Replies auf ICMP-Echo-Requests betrachtet werden.
Dies haben wir zunächst für das 1-Hop-Szenario sowohl für das B.A.T.M.A.N.- und anschließend für das OLSR-Protokoll durchgeführt.

\subsubsection*{B.A.T.M.A.N.}

Da bei uns und anderen Teilnehmern des Praktikums bzgl. B.A.T.M.A.N. durchgehend Probleme bei der Ende-zu-Ende-Kommunikation auftraten mussten wir die Ping-Messungen bzgl. des Jitters für B.A.T.M.A.N. von Router zur Router messen.
...
Vor für das Multi-Hop-Szenario variiert die Latenz deutlich.

\subsubsection*{OLSR}

Bei OLSR waren uns Messungen von Ende zu Ende möglich.
...
Der Jitter scheint daher bei beiden Protokollen, auch in Abhängigkeit von der Hop-Anzahl, ähnlich zu sein.
...
\subsubsection*{Messungen mit Iperf bzgl. des Jitters für B.A.T.M.A.N.}
...
Der hohe Packet-Loss bei den Messungen weist auf starke Schwankungen der Verbindungsqualität hin.

\subsubsection*{Messungen mit Iperf bzgl. des Jitters für OLSR}
